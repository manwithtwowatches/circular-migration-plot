...
},{"./lib/chart":2,"./lib/timeline":6}],2:[function(_dereq_,module,exports){
// Initialize diagram
...
module.exports = function(data, config) {
  ...
  config.mylayout.labelThreshold = config.mylayout.labelThreshold || 100000;
  ...
  // svg element
  var svg = config.svg_element || d3.select(config.element).append("svg")
  ...
  function groupInfo(d) {
    ...
    infoTimer = setTimeout(function() {
      ...
      var text = info.select('.text').selectAll('text')
        .data([
          data.names[d.id],
          (MP ? MP.getCaption('totalIn') : 'Total In: ') + formatNumber(d.inflow), // Look for MPJS translations
          (MP ? MP.getCaption('totalOut') : 'Total Out: ') + formatNumber(d.outflow)
        ]);
...
},{"./chord":3,"./layout":5}],3:[function(_dereq_,module,exports){
...
},{"./countrymerge":4}],6:[function(_dereq_,module,exports){
